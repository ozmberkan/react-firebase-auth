    ...
    return (
        <div>
            <form onSubmit={handleSubmit} className='max-w-xl mx-auto flex flex-col gap-y-5 mt-6'>
                ...
                <button disabled={!email || !password} className='p-3 bg-indigo-700 text-indigo-100 w-1/3 rounded-md cursor-pointer disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-default' type='submit'>Kayıt Ol</button>
            </form>
        </div>
    )
}
